...
#$userCommand = '-command &{Start-Process -FilePath "C:\Program Files (x86)\Teams Installer\Teams.exe"}'
#executeAsLoggedOnUser -Command $userCommand -Hidden $false

executeAsLoggedOnUser -Command "C:\Program Files (x86)\Teams Installer\Teams.exe" -Hidden $false
