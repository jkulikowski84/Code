 ...
 (function($){
    ...
    $.fn.repo = function( options ){
                    ...
                    $.each(arr, function(i){
                        ...
                        if(!exists){
                            ...
                            ctx.folders.push({
                                ...
                                folders     : [],
                                files       : [],
                                element     : $('<div class="page" id="' + id + '"><ul><li class="titles"><span>Directory Path</span></li><li class="back"><a href="#">..</a></li></ul></page>').appendTo(_this.container)[0]
                            });
        ...
        return this.each(function(){
            _this.container = $('<div class="repo"><h1><a href="#" data-id="' + _this.namespace + '_split_default">' + _this.settings.name + '</a></h1><div class="loader"></div><div class="page" id="' + _this.namespace + '_split_default"><ul><li class="titles"><span>Directory Path</span></li></ul></div></div>').appendTo($(this));
        });
    };
